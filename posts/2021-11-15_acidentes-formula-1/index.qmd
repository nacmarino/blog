...
df %>% 
  ...
  mutate(mes_str = month(x = data, label = TRUE, abbr = FALSE)) %>% 
  # agrupando pelo mes
  group_by(mes_str) %>% 
...
```{r acidentes_por_forca_competicao}
#| fig-dpi: 200
#| fig-height: 5
#| fig-width: 8
#| code-fold: true
