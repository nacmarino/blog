...
tbl1 <- df1 %>% 
  ...
  tab_options(column_labels.padding = px(10), table.font.names = 'IBM Plex Sans', 
              column_labels.border.top.width = px(3), column_labels.border.top.color = 'grey70', 
              column_labels.border.bottom.width = px(2), column_labels.border.bottom.color = 'grey70',
              table.border.bottom.color = 'grey70', table.border.bottom.width = px(3))
...
tbl1 <- df %>% 
  ...
  tab_options(table.font.names = 'IBM Plex Sans', column_labels.hidden = TRUE, table.align = 'right', 
              table.margin.left = 60, table.border.top.color = 'grey70', table.border.top.width = px(3),
              table.border.bottom.color = 'grey70', table.border.bottom.width = px(3)) %>% 
  cols_label()
...
tbl2 <- df %>% 
  ...
  tab_options(table.font.names = 'IBM Plex Sans', column_labels.hidden = TRUE, table.align = 'left', 
              table.margin.right = 60, table.border.top.color = 'grey70', table.border.top.width = px(3),
              table.border.bottom.color = 'grey70', table.border.bottom.width = px(3)) %>% 
  cols_label()
...
tribble(
  ...
  tab_options(column_labels.hidden = TRUE, row_group.as_column = TRUE, table.font.names = 'IBM Plex Sans',
              table.border.bottom.width = px(3), table.border.top.width = px(3), table.border.bottom.color = 'grey70',
              table.border.top.color = 'grey70', row_group.border.bottom.with = 4)
```
:::
