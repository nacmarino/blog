...
***AI/ML Computational Science Manager*** [Jun 2024 -- Atual]{.cvdate}

*Tech lead* e *arquiteto de soluções* de inteligência artificial, *machine learning* e ciência de dados, focado principalmente para problemas relacionados à indústria de mineração.

***Data Science Principal*** [Jan 2021 -- Mai 2024]{.cvdate}
...
tribble(
  ...
  'DeepLearning.AI'      , 'Quantization Fundamentals with Hugging Face'                                                , 2024,
  'DeepLearning.AI'      , 'Prompt Engineering with Llama 2 & 3'                                                        , 2024,
  'DeepLearning.AI'      , 'Reinforcement Learning from Human Feedback'                                                 , 2024,
  'DeepLearning.AI'      , 'Prompt Engineering for Vision Models'                                                       , 2024,
  'DeepLearning.AI'      , 'Embedding Models: from Architecture to Implementation'                                      , 2024,
  'DeepLearning.AI'      , 'Introductionto on-device AI'                                                                , 2024,
  'DeepLearning.AI'      , 'Carbon Aware Computing for GenAI Developers'                                                , 2024,
  'DeepLearning.AI'      , 'Red Teaming LLM Applications'                                                               , 2024,
  'DeepLearning.AI'      , 'Introduction to on-device AI'                                                               , 2024,
  'DeepLearning.AI'      , 'Intro to Federated Learning'                                                                , 2024,  
  'DeepLearning.AI'      , 'AI Python for Beginners: Basics of AI Python Coding'                                        , 2024,
  'DeepLearning.AI'      , 'Multimodal RAG: Chat with Videos'                                                           , 2025
) %>% 
  arrange(ano, fornecedor, curso) %>% 
  gt(groupname_col = 'ano') %>%
